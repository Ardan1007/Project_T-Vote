...
<head>
    ...
    <title>Edit Kandidat Event Vote</title>
	<style>
        body, html {
            height: 100%;
            margin: 0;
...
<body>
    ...
    &larr; Kembali
            ...
            <h2>Edit Kandidat Event Vote</h2>
            <?php echo validation_errors(); ?>
            <?php if(isset($error)) echo $error; ?>

            <form action="<?php echo base_url('KandidatEventVote/edit/'.$KandidatEventVote['id']); ?>" method="post" enctype="multipart/form-data">
                <div class="mb-3">
